function __vite__mapDeps(indexes) {
    if (!__vite__mapDeps.viteFileDeps) {
        __vite__mapDeps.viteFileDeps = ["./0-Xt6-fw.js", "./Bfc6mzjo.js", "./entry.CXNFOBZt.css"]
    }
    return indexes.map( (i) => __vite__mapDeps.viteFileDeps[i])
}
import {b2 as fe} from "./Bfc6mzjo.js";
const me = Symbol()
  , ee = Object.getPrototypeOf
  , G = new WeakMap
  , ge = e => e && (G.has(e) ? G.get(e) : ee(e) === Object.prototype || ee(e) === Array.prototype)
  , he = e => ge(e) && e[me] || null
  , te = (e, t=!0) => {
    G.set(e, t)
}
...
const q = e => typeof e == "object" && e !== null
  , A = new WeakMap
  , x = new WeakSet
  , be = (e=Object.is, t= (n, h) => new Proxy(n,h), s=n => q(n) && !x.has(n) && (Array.isArray(n) || !(Symbol.iterator in n)) && !(n instanceof WeakMap) && !(n instanceof WeakSet) && !(n instanceof Error) && !(n instanceof Number) && !(n instanceof Date) && !(n instanceof String) && !(n instanceof RegExp) && !(n instanceof ArrayBuffer), r=n => {
    switch (n.status) {
    case "fulfilled":
        return n.value;
    case "rejected":
...
, l=new WeakMap, c= (n, h, I=r) => {
    ...
    Reflect.ownKeys(n).forEach(S => {
        if (Object.getOwnPropertyDescriptor(v, S))
            return;
    ...
    () => {
      ...
      , $ = t(J, {
        deleteProperty(a, i) {
            ...
            return g && v(["delete", [i], o]),
            g
        },
        set(a, i, o, g) {
            const _ = Reflect.has(a, i)
              , R = Reflect.get(a, i, g);
            if (_ && (e(R, o) || m.has(o) && e(R, m.get(o))))
                return !0;
            Z(i),
            q(o) && (o = he(o) || o);
            let V = o;
...
const d = j({
  ...
  , de = {
    ...
    replace(e) {
        d.history.length > 1 && (d.history[d.history.length - 1] = e,
        d.view = e)
    },
    goBack() {
  ...
  , we = typeof location < "u" && (location.hostname.includes("localhost") || location.protocol.includes("https"))
  , u = j({
    enabled: we,
    userSessionId: "",
    events: [],
...
const ie = p.isMobile()
  ...
  , Te = {
    ...
    async getRecomendedWallets() {
        ...
        if (p.isArray(e)) {
            ...
            const {chains: s, isAuth: r} = w.state
              ...
              , {listings: f} = ie ? await U.getMobileListings(m) : await U.getDesktopListings(m);
    ...
    async getWallets(e) {
        const t = Me({}, e)
          , {explorerRecommendedWalletIds: s, explorerExcludedWalletIds: r} = N.state
          , {recomendedWallets: l} = O;
        if (r === "ALL")
            return O.wallets;
        l.length ? t.excludedIds = l.map(I => I.id).join(",") : p.isArray(s) && (t.excludedIds = s.join(",")),
        p.isArray(r) && (t.excludedIds = [t.excludedIds, r].filter(Boolean).join(",")),
        w.state.isAuth && (t.sdks = "auth_v1");
        const {page: c, search: m} = e
          , {listings: f, total: W} = ie ? await U.getMobileListings(t) : await U.getDesktopListings(t)
          , n = Object.values(f)
          , h = m ? "search" : "wallets";
        return O[h] = {
            listings: [...O[h].listings, ...n],
            total: W,
            page: c ?? 1
        },
        {
  ...
  , F = {
    ...
    async open(e) {
        return new Promise(t => {
            ...
            if (p.removeWalletConnectDeepLink(),
...
class ke {
    ...
    async initUi() {
        if (typeof window < "u") {
            await fe( () => import("./0-Xt6-fw.js"), __vite__mapDeps([0, 1, 2]), import.meta.url);
...
export {Ie as R, de as T, p as a, Ve as i, ce as n, $e as o, w as p, F as s, Te as t, N as y};
