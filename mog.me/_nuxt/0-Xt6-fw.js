import {n as _t, s as ce, T as N, t as W, a as C, o as ot, R as Uo, p as K, y as gt} from "./CRUdGszt.js";
import "./Bfc6mzjo.js";
var oo = {
    exports: {}
};
...
;
const Wo = e => new no(typeof e == "string" ? e : e + "",void 0,wr)
  , I = (e, ...t) => {
...
let $t = class extends HTMLElement {
    ...
    createRenderRoot() {
        ...
        return Ho(r, this.constructor.elementStyles),
        r
    }
    connectedCallback() {
        var t;
    ...
    requestUpdate(t, r, n) {
        let o = !0;
        t !== void 0 && (((n = n || this.constructor.getPropertyOptions(t)).hasChanged || io)(this[t], r) ? (this._$AL.has(t) || this._$AL.set(t, r),
...
const Vo = (e, t) => {
    ...
    for (let a = 0; a < r; a++) {
        const l = e[a];
        let c, d, b = -1, h = 0;
        for (; h < l.length && (s.lastIndex = h,
        d = s.exec(l),
        d !== null); )
            h = s.lastIndex,
            s === Rt ? d[1] === "!--" ? s = Tr : d[1] !== void 0 ? s = Pr : d[2] !== void 0 ? (lo.test(d[2]) && (o = RegExp("</" + d[2], "g")),
            s = lt) : d[3] !== void 0 && (s = lt) : s === lt ? d[0] === ">" ? (s = o ?? Rt,
            b = -1) : d[1] === void 0 ? b = -2 : (b = s.lastIndex - d[2].length,
            c = d[1],
            s = d[3] === void 0 ? lt : d[3] === '"' ? Sr : Mr) : s === Sr || s === Mr ? s = lt : s === Tr || s === Pr ? s = Rt : (s = lt,
            o = void 0);
        const f = s === lt && e[a + 1].startsWith("/>") ? " " : "";
        i += s === Rt ? l + Fo : b >= 0 ? (n.push(c),
        l.slice(0, b) + lr + l.slice(b) + rt + f) : l + rt + (b === -2 ? (n.push(void 0),
        a) : f)
    }
...
class Kt {
    constructor({strings: t, _$litType$: r}, n) {
        ...
        const a = t.length - 1
          , l = this.parts
          , [c,d] = Vo(t, r);
        if (this.el = Kt.createElement(c, n),
...
function kt(e, t, r=e, n) {
    ...
    return (l == null ? void 0 : l.constructor) !== c && ((i = l == null ? void 0 : l._$AO) === null || i === void 0 || i.call(l, !1),
    c === void 0 ? l = void 0 : (l = new c(e),
    l._$AT(e, r, n)),
...
class Ko {
    ...
    u(t) {
        ...
        for (; c !== void 0; ) {
            if (a === c.index) {
                let d;
                c.type === 2 ? d = new Jt(s,s.nextSibling,this,t) : c.type === 1 ? d = new c.ctor(s,c.name,c.strings,this,t) : c.type === 6 && (d = new Qo(s,this,t)),
                this._$AV.push(d),
                c = o[++l]
            }
            a !== (c == null ? void 0 : c.index) && (s = ut.nextNode(),
            a++)
        }
        return ut.currentNode = ft,
        i
    }
    v(t) {
        let r = 0;
...
class Jt {
    ...
    _$AI(t, r=this) {
        t = kt(this, t, r),
        Vt(t) ? t === B || t == null || t === "" ? (this._$AH !== B && this._$AR(),
        this._$AH = B) : t !== this._$AH && t !== pt && this._(t) : t._$litType$ !== void 0 ? this.g(t) : t.nodeType !== void 0 ? this.$(t) : Zo(t) ? this.T(t) : this._(t)
    }
    k(t) {
    ...
    _(t) {
        this._$AH !== B && Vt(this._$AH) ? this._$AA.nextSibling.data = t : this.$(ft.createTextNode(t)),
        this._$AH = t
    }
    g(t) {
        var r;
        const {values: n, _$litType$: o} = t
          , i = typeof o == "number" ? this._$AC(t) : (o.el === void 0 && (o.el = Kt.createElement(ho(o.h, o.h[0]), this.options)),
        o);
        if (((r = this._$AH) === null || r === void 0 ? void 0 : r._$AD) === i)
            this._$AH.v(n);
        else {
            const s = new Ko(i,this)
              , a = s.u(this.options);
            s.v(n),
            this.$(a),
            this._$AH = s
    ...
    _$AC(t) {
        ...
        return r === void 0 && Rr.set(t.strings, r = new Kt(t)),
        r
    }
    T(t) {
        ao(this._$AH) || (this._$AH = [],
        this._$AR());
        const r = this._$AH;
        let n, o = 0;
        for (const i of t)
            o === r.length ? r.push(n = new Jt(this.k(Zt()),this.k(Zt()),this,this.options)) : n = r[o],
            n._$AI(i),
            o++;
...
class A extends $t {
    ...
    update(t) {
        ...
        super.update(t),
        this._$Do = Xo(r, this.renderRoot, this.renderOptions)
    }
    connectedCallback() {
        var t;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const k = e => t => typeof t == "function" ? ( (r, n) => (customElements.define(r, n),
n))(e, t) : ( (r, n) => {
...
const G = on(class extends nn {
    constructor(e) {
        var t;
        if (super(e),
        e.type !== rn.ATTRIBUTE || e.name !== "class" || ((t = e.strings) === null || t === void 0 ? void 0 : t.length) > 2)
    ...
    constructor(t, r=[0, 1], {easing: n, duration: o=Z.duration, delay: i=Z.delay, endDelay: s=Z.endDelay, repeat: a=Z.repeat, offset: l, direction: c="normal", autoplay: d=!0}={}) {
        ...
        this.tick = h => {
            ...
            const w = p >= this.totalDuration ? 1 : Math.min(u, 1)
              , v = b(this.easing(w));
            t(v),
            this.pauseTime === void 0 && (this.playState === "finished" || p >= this.totalDuration + s) ? (this.playState = "finished",
            (f = this.resolve) === null || f === void 0 || f.call(this, v)) : this.playState !== "idle" && (this.frameRequestId = requestAnimationFrame(this.tick))
        }
        ,
        d && this.play()
    }
...
const $n = (e, t) => fe.indexOf(e) - fe.indexOf(t)
  , Cn = new Set(fe)
  , yo = e => Cn.has(e)
  , En = (e, t) => {
    ge[t] && (t = ge[t]);
    ...
    sn(r, t),
    e.style.transform = An(r)
}
  , An = e => e.sort($n).reduce(_n, "").trim()
  , _n = (e, t) => `${e} ${t}(var(${br(t)}))`
  , dr = e => e.startsWith("--")
  , jr = new Set;
function On(e) {
...
const kn = .015
  ...
  , Hr = (e, t) => It(e) ? Ct.linearEasing() ? `linear(${In(e, t)})` : Z.easing : po(e) ? Tn(e) : e
...
const Xt = {
    ...
    set: (e, t, r) => {
        t = hr(t),
        dr(t) ? e.style.setProperty(t, r) : e.style[t] = r
    }
};
function xo(e, t=!0) {
...
function Ln(e, t, r, n={}, o) {
    ...
    () => {
        ...
        if (dr(E) && (Ct.cssRegisterProperty() ? On(E) : v = !1),
        ...
        v) {
            ...
            a.finished || (a.finished = new Promise( (D, Do) => {
                a.onfinish = D,
                a.oncancel = Do
            }
            ));
...
const Dn = e => e()
  ...
  , jn = {
    get: (e, t) => {
        ...
        case "finished":
            return e.finished || (e.finished = Promise.all(e.animations.map(Wn)).catch(go)),
            e.finished;
        case "stop":
            return () => {
...
(function(e) {
    ...
    e.getPositions = function(n) {
        ...
        for (let a = 0; a < s; a++)
            for (let l = 0; l < s; l++)
                a === 0 && l === 0 || a === 0 && l === s - 1 || a === s - 1 && l === 0 || o.push([i[a], i[l]]);
        return o
    }
}
)(Ao);
var _o = {};
const Jn = F.getSymbolSize
  , zr = 7;
_o.getPositions = function(t) {
    const r = Jn(t);
    return [[0, 0], [r - zr, 0], [0, r - zr]]
}
;
var Oo = {};
(function(e) {
    ...
    e.getPenaltyN1 = function(o) {
        ...
        for (let b = 0; b < i; b++) {
            ...
            for (let h = 0; h < i; h++) {
                let f = o.get(b, h);
                f === c ? a++ : (a >= 5 && (s += t.N1 + (a - 5)),
                c = f,
                a = 1),
                f = o.get(h, b),
                f === d ? l++ : (l >= 5 && (s += t.N1 + (l - 5)),
                d = f,
                l = 1)
            }
            a >= 5 && (s += t.N1 + (a - 5)),
...
xr.prototype.initialize = function(t) {
    this.degree = t,
    this.genPoly = Io.generateECPolynomial(this.degree)
}
;
...
const ur = F
  , So = 1335
  , oi = 21522
  , Fr = ur.getBCHDigit(So);
Mo.getEncodedBits = function(t, r) {
    const n = t.bit << 3 | r;
    let o = n << 10;
    for (; ur.getBCHDigit(o) - Fr >= 0; )
        o ^= So << ur.getBCHDigit(o) - Fr;
    return (n << 10 | o) ^ oi
}
;
var Ro = {};
...
(function(e) {
    ...
    function b(u) {
        ...
        let v, E;
        return a.isKanjiModeEnabled() ? (v = d(s.BYTE, t.BYTE, u),
        E = d(s.KANJI, t.KANJI, u)) : (v = d(s.BYTE_KANJI, t.BYTE, u),
        E = []),
        y.concat(w, v, E).sort(function(S, U) {
        ...
        for (let M = 0; M < u.length; M++) {
            ...
            for (let P = 0; P < S.length; P++) {
                ...
                for (let Y = 0; Y < E.length; Y++) {
                    const D = E[Y];
                    w[D] && w[D].node.mode === z.mode ? (v[D][R] = h(w[D].lastCount + z.length, z.mode) - h(w[D].lastCount, z.mode),
                    w[D].lastCount += z.length) : (w[D] && (w[D].lastCount = z.length),
 ...
 Suggested mode is: ` + t.toString(v));
        switch (w === t.KANJI && !a.isKanjiModeEnabled() && (w = t.BYTE),
        w) {
        case t.NUMERIC:
            return new r(u);
        case t.ALPHANUMERIC:
    ...
    e.fromArray = function(y) {
        return y.reduce(function(w, v) {
            return typeof v == "string" ? w.push(_(v, null)) : v.data && w.push(_(v.data, v.mode)),
            w
        }, [])
    }
    ,
...
function Oi(e, t, r) {
    ...
    r.forEach(function(l) {
        n.put(l.mode.bit, 4),
        n.put(l.getLength(), xi.getCharCountIndicator(l.mode, e)),
        l.write(n)
    });
...
Co.create = function(t, r) {
    ...
    let n = Re.M, o, i;
    return typeof r < "u" && (n = Re.from(r.errorCorrectionLevel, Re.M),
    o = we.from(r.version),
...
(function(e) {
    ...
    e.render = function(i, s, a) {
        ...
        return t.qrToImageData(h.data, i, l),
        r(b, c, d),
...
function Pi(e, t, r) {
    ...
    for (let a = 0; a < e.length; a++) {
        ...
        !l && !i && (i = !0),
        e[a] ? (s++,
        a > 0 && l > 0 && e[a - 1] || (n += i ? Be("M", l + r, .5 + c + r) : Be("m", o, 0),
        o = 0,
        i = !1),
        l + 1 < t && e[a + 1] || (n += Be("h", s),
        s = 0)) : o++
    }
    return n
}
No.render = function(t, r, n) {
    const o = Ti.getOptions(r)
      ...
      , c = "<path " + Zr(o.color.dark, "stroke") + ' d="' + Pi(s, i, o.margin) + '"/>'
      , d = 'viewBox="0 0 ' + a + " " + a + '"'
...
var Ri = Object.defineProperty
  ...
  , De = (e, t) => {
    for (var r in t || (t = {}))
        Li.call(t, r) && Kr(e, r, t[r]);
    if (Vr)
        for (var r of Vr(t))
            Ni.call(t, r) && Kr(e, r, t[r]);
    return e
}
;
function Bi() {
...
const O = {
  ...
  , Di = I`button{border-radius:var(--wcm-secondary-button-border-radius);height:28px;padding:0 10px;background-color:var(--wcm-accent-color)}button path{fill:var(--wcm-accent-fill-color)}button::after{border-radius:inherit;border:1px solid var(--wcm-color-overlay)}button:disabled::after{background-color:transparent}.wcm-icon-left svg{margin-right:5px}.wcm-icon-right svg{margin-left:5px}button:active::after{background-color:var(--wcm-color-overlay)}.wcm-ghost,.wcm-ghost:active::after,.wcm-outline{background-color:transparent}.wcm-ghost:active{opacity:.5}@media(hover:hover){button:hover::after{background-color:var(--wcm-color-overlay)}.wcm-ghost:hover::after{background-color:transparent}.wcm-ghost:hover{opacity:.5}}button:disabled{background-color:var(--wcm-color-bg-3);pointer-events:none}.wcm-ghost::after{border-color:transparent}.wcm-ghost path{fill:var(--wcm-color-fg-2)}.wcm-outline path{fill:var(--wcm-accent-color)}.wcm-outline:disabled{background-color:transparent;opacity:.5}`;
...
Q = wt([k("wcm-button")], Q);
const Wi = I`:host{display:inline-block}button{padding:0 15px 1px;height:40px;border-radius:var(--wcm-button-border-radius);color:var(--wcm-accent-fill-color);background-color:var(--wcm-accent-color)}button::after{content:'';top:0;bottom:0;left:0;right:0;position:absolute;background-color:transparent;border-radius:inherit;transition:background-color .2s ease;border:1px solid var(--wcm-color-overlay)}button:active::after{background-color:var(--wcm-color-overlay)}button:disabled{padding-bottom:0;background-color:var(--wcm-color-bg-3);color:var(--wcm-color-fg-3)}.wcm-secondary{color:var(--wcm-accent-color);background-color:transparent}.wcm-secondary::after{display:none}@media(hover:hover){button:hover::after{background-color:var(--wcm-color-overlay)}}`;
...
;
je.styles = [O.globalCss, Fi],
je = Ki([k("wcm-info-footer")], je);
const T = {
  ...
  , qi = I`.wcm-toolbar-placeholder{top:0;bottom:0;left:0;right:0;width:100%;position:absolute;display:block;pointer-events:none;height:100px;border-radius:calc(var(--wcm-background-border-radius) * .9);background-color:var(--wcm-background-color);background-position:center;background-size:cover}.wcm-toolbar{height:38px;display:flex;position:relative;margin:5px 15px 5px 5px;justify-content:space-between;align-items:center}.wcm-toolbar img,.wcm-toolbar svg{height:28px;object-position:left center;object-fit:contain}#wcm-wc-logo path{fill:var(--wcm-accent-fill-color)}button{width:28px;height:28px;border-radius:var(--wcm-icon-button-border-radius);border:0;display:flex;justify-content:center;align-items:center;cursor:pointer;background-color:var(--wcm-color-bg-1);box-shadow:0 0 0 1px var(--wcm-color-overlay)}button:active{background-color:var(--wcm-color-bg-2)}button svg{display:block;object-position:center}button path{fill:var(--wcm-color-fg-1)}.wcm-toolbar div{display:flex}@media(hover:hover){button:hover{background-color:var(--wcm-color-bg-2)}}`;
...
;
We.styles = [O.globalCss, qi],
We = Gi([k("wcm-modal-backcard")], We);
const Qi = I`main{padding:20px;padding-top:0;width:100%}`;
...
;
He.styles = [O.globalCss, Qi],
He = es([k("wcm-modal-content")], He);
...
;
ze.styles = [O.globalCss, rs],
ze = is([k("wcm-modal-footer")], ze);
...
const x = {
    ...
    handleMobileLinking(e) {
        ...
        function s(a) {
            let l = "";
            o ? l = C.formatUniversalUrl(o, a, n) : i && (l = C.formatNativeUrl(i, a, n)),
            C.openHref(l, "_self")
        }
        t && s(t)
    },
    handleAndroidLinking() {
        ...
        e && (C.setWalletConnectAndroidDeepLink(e),
        C.openHref(e, "_self"))
    },
    async handleUriCopy() {
        const {walletConnectUri: e} = K.state;
...
let re = class extends A {
    constructor() {
        ...
        this.unsubscribe = ot.subscribe(e => {
            e.open ? (this.open = !0,
            this.timeout = setTimeout( () => ot.closeToast(), 2200)) : (this.open = !1,
...
;
re.styles = [O.globalCss, us],
Yr([H()], re.prototype, "open", 2),
re = Yr([k("wcm-modal-toast")], re);
const fs = .1
  , Jr = 2.5
  , J = 7;
function Ze(e, t, r) {
...
;
oe.styles = [O.globalCss, xs],
Gr([$()], oe.prototype, "onChange", 2),
oe = Gr([k("wcm-search-input")], oe);
...
tt([$({
    type: Boolean
})], V.prototype, "installed", 2),
tt([$({
    type: Boolean
})], V.prototype, "recent", 2),
...
let qe = class extends A {
    ...
    async preloadData() {
        try {
            ...
            console.error(e),
            ot.openToast("Failed preloading", "error")
        }
    }
}
;
Qr([H()], qe.prototype, "preload", 2),
qe = Qr([k("wcm-explorer-context")], qe);
...
let Xr = class extends A {
    constructor() {
        ...
        O.setTheme(),
        this.unsubscribeTheme = _t.subscribe(O.setTheme)
    }
    disconnectedCallback() {
        var e;
...
;
Ye.styles = [O.globalCss, Hs],
Ye = Zs([k("wcm-android-wallet-selection")], Ye);
...
let et = class extends A {
    ...
    svgLoaderTemplate() {
        ...
        let n = 0;
        r.includes("%") ? n = 88 / 100 * parseInt(r, 10) : n = parseInt(r, 10),
        n *= 1.17;
        const o = 317 - n * 1.57
          , i = 425 - n * 1.8;
...
;
et.styles = [O.globalCss, Vs],
yt([$()], et.prototype, "walletId", 2),
yt([$()], et.prototype, "imageId", 2),
yt([$({
    type: Boolean
})], et.prototype, "isError", 2),
yt([$({
    type: Boolean
})], et.prototype, "isStale", 2),
...
const At = {
    manualWallets() {
        ...
        return (t = C.isMobile() ? s == null ? void 0 : s.map( ({id: a, name: l, links: c}) => ({
            id: a,
            name: l,
            mobile: c,
            links: c
        })) : s == null ? void 0 : s.map( ({id: a, name: l, links: c}) => ({
            id: a,
            name: l,
            desktop: c,
            links: c
...
;
Je.styles = [O.globalCss, Ys],
Je = Qs([k("wcm-desktop-wallet-selection")], Je);
...
;
Ge.styles = [O.globalCss, Xs],
Ge = ra([k("wcm-legal-notice")], Ge);
const oa = I`div{display:grid;grid-template-columns:repeat(4,80px);margin:0 -10px;justify-content:space-between;row-gap:10px}`;
...
;
Qe.styles = [O.globalCss, oa],
Qe = sa([k("wcm-mobile-wallet-selection")], Qe);
const aa = I`:host{all:initial}.wcm-overlay{top:0;bottom:0;left:0;right:0;position:fixed;z-index:var(--wcm-z-index);overflow:hidden;display:flex;justify-content:center;align-items:center;opacity:0;pointer-events:none;background-color:var(--wcm-overlay-background-color);backdrop-filter:var(--wcm-overlay-backdrop-filter)}@media(max-height:720px) and (orientation:landscape){.wcm-overlay{overflow:scroll;align-items:flex-start;padding:20px 0}}.wcm-active{pointer-events:auto}.wcm-container{position:relative;max-width:360px;width:100%;outline:0;border-radius:var(--wcm-background-border-radius) var(--wcm-background-border-radius) var(--wcm-container-border-radius) var(--wcm-container-border-radius);border:1px solid var(--wcm-color-overlay);overflow:hidden}.wcm-card{width:100%;position:relative;border-radius:var(--wcm-container-border-radius);overflow:hidden;box-shadow:0 6px 14px -6px rgba(10,16,31,.12),0 10px 32px -4px rgba(10,16,31,.1),0 0 0 1px var(--wcm-color-overlay);background-color:var(--wcm-color-bg-1);color:var(--wcm-color-fg-1)}@media(max-width:600px){.wcm-container{max-width:440px;border-radius:var(--wcm-background-border-radius) var(--wcm-background-border-radius) 0 0}.wcm-card{border-radius:var(--wcm-container-border-radius) var(--wcm-container-border-radius) 0 0}.wcm-overlay{align-items:flex-end}}@media(max-width:440px){.wcm-container{border:0}}`;
...
;
Ut.styles = [O.globalCss, aa],
Xe([H()], Ut.prototype, "open", 2),
Xe([H()], Ut.prototype, "active", 2),
Ut = Xe([k("wcm-modal")], Ut);
const da = I`div{display:flex;margin-top:15px}slot{display:inline-block;margin:0 5px}wcm-button{margin:0 5px}`;
...
;
dt.styles = [O.globalCss, da],
jt([$({
    type: Boolean
})], dt.prototype, "isMobile", 2),
jt([$({
    type: Boolean
})], dt.prototype, "isDesktop", 2),
jt([$({
    type: Boolean
})], dt.prototype, "isWeb", 2),
jt([$({
    type: Boolean
})], dt.prototype, "isRetry", 2),
dt = jt([k("wcm-platform-selection")], dt);
const ma = I`button{display:flex;flex-direction:column;padding:5px 10px;border-radius:var(--wcm-button-hover-highlight-border-radius);height:100%;justify-content:flex-start}.wcm-icons{width:60px;height:60px;display:flex;flex-wrap:wrap;padding:7px;border-radius:var(--wcm-wallet-icon-border-radius);justify-content:space-between;align-items:center;margin-bottom:5px;background-color:var(--wcm-color-bg-2);box-shadow:inset 0 0 0 1px var(--wcm-color-overlay)}button:active{background-color:var(--wcm-color-overlay)}@media(hover:hover){button:hover{background-color:var(--wcm-color-overlay)}}.wcm-icons img{width:21px;height:21px;object-fit:cover;object-position:center;border-radius:calc(var(--wcm-wallet-icon-border-radius)/ 2);border:1px solid var(--wcm-color-overlay)}.wcm-icons svg{width:21px;height:21px}.wcm-icons img:nth-child(1),.wcm-icons img:nth-child(2),.wcm-icons svg:nth-child(1),.wcm-icons svg:nth-child(2){margin-bottom:4px}wcm-text{width:100%;text-align:center}#wallet-placeholder-fill{fill:var(--wcm-color-bg-3)}#wallet-placeholder-dash{stroke:var(--wcm-color-overlay)}`;
...
;
tr.styles = [O.globalCss, ma],
tr = pa([k("wcm-view-all-wallets-button")], tr);
const wa = I`.wcm-qr-container{width:100%;display:flex;justify-content:center;align-items:center;aspect-ratio:1/1}`;
...
;
er.styles = [O.globalCss],
er = $a([k("wcm-connect-wallet-view")], er);
const Ca = I`wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-text{text-align:center}`;
...
;
se.styles = [O.globalCss, Ca],
to([H()], se.prototype, "isError", 2),
se = to([k("wcm-desktop-connecting-view")], se);
const _a = I`wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-text{text-align:center}wcm-button{margin-top:15px}`;
...
;
ae.styles = [O.globalCss, Ta],
eo([H()], ae.prototype, "isError", 2),
ae = eo([k("wcm-mobile-connecting-view")], ae);
const Sa = I`wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-text{text-align:center}`;
...
;
or.styles = [O.globalCss, Sa],
or = Na([k("wcm-mobile-qr-connecting-view")], or);
...
;
nr.styles = [O.globalCss],
nr = Ua([k("wcm-qrcode-view")], nr);
const ja = I`wcm-modal-content{height:clamp(200px,60vh,600px);display:block;overflow:scroll;scrollbar-width:none;position:relative;margin-top:1px}.wcm-grid{display:grid;grid-template-columns:repeat(4,80px);justify-content:space-between;margin:-15px -10px;padding-top:20px}wcm-modal-content::after,wcm-modal-content::before{content:'';position:fixed;pointer-events:none;z-index:1;width:100%;height:20px;opacity:1}wcm-modal-content::before{box-shadow:0 -1px 0 0 var(--wcm-color-bg-1);background:linear-gradient(var(--wcm-color-bg-1),rgba(255,255,255,0))}wcm-modal-content::after{box-shadow:0 1px 0 0 var(--wcm-color-bg-1);background:linear-gradient(rgba(255,255,255,0),var(--wcm-color-bg-1));top:calc(100% - 20px)}wcm-modal-content::-webkit-scrollbar{display:none}.wcm-placeholder-block{display:flex;justify-content:center;align-items:center;height:100px;overflow:hidden}.wcm-empty,.wcm-loading{display:flex}.wcm-loading .wcm-placeholder-block{height:100%}.wcm-end-reached .wcm-placeholder-block{height:0;opacity:0}.wcm-empty .wcm-placeholder-block{opacity:1;height:100%}wcm-wallet-button{margin:calc((100% - 60px)/ 3) 0}`;
...
let ht = class extends A {
    ...
    async fetchWallets() {
        ...
        if (!this.endReached && (this.firstFetch || o > ir && n.length < o))
            try {
                ...
                console.error(s),
                ot.openToast(x.getErrorMessage(s), "error")
            } finally {
                this.loading = !1,
                this.firstFetch = !1
            }
    ...
    render() {
        ...
        o && (i = i.filter( ({values: c}) => x.caseSafeIncludes(c[0], this.search)),
...
;
le.styles = [O.globalCss, za],
ro([H()], le.prototype, "isError", 2),
le = ro([k("wcm-web-connecting-view")], le);
